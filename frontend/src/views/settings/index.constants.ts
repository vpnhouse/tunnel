...
export const PATTERNS = {
  ...
  cidr: /^((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\/([8-9]|[1-2][0-9]|[3][0]?)$/
};

export const PATTERN_ERRORS = {
  dnsName: 'Invalid DNS name format',
  ipv4: 'Invalid IPV4 format',
  cidr: 'Invalid subnet mask format. It must match pattern: IPV4/number between 8 and 30',
